...
// πρέπει να κάνει implements Serializable καθώς το αντικείμενο αυτό θα περνάει σε μια μέθοδο του interface ώστε να το λάβει ο Server_1
//must do implements Serializable so Server_1 receive this object
public class Data implements Serializable {
    ...
    //Στο συγκεκριμένο toString πρέπει να εμφανίζονται σε μορφή γλώσσας html ώστε να μπορέσουν 
    //να εκτυπωθούν στο Gui σε μορφή λίστας
    //At this toString we must write html code so it can be shown at Gui with list form
